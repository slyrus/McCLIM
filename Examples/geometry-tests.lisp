...
(defmethod handle-repaint ((pane simple-pane) region)
  ...
  (multiple-value-bind (x1 y1 x2 y2)
    ...
    (draw-rectangle* pane (+ x1 10) (+ y1 10) (- x2 10) (- y2 10) :line-thickness 5 :ink +red+ :filled nil)
    (draw-rectangle* pane (+ x1 15) (+ y1 15) (- x2 15) (- y2 15) :line-thickness 5 :ink +light-blue+ :filled t)
