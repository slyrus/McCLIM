...
(defun bounding-rectangle* (presentation)
  ...
  (let ((stream *standard-output*))
    ...
    (multiple-value-bind (xoff yoff)
        (climi::convert-from-relative-to-absolute-coordinates stream
                                                              (clim::output-record-parent presentation))
...
(defun menu-choose (choices &key (prompt "Choose:")
                                 default-choice)
...
(define-presentation-type-abbreviation alist-member (&key alist (test 'eql))
